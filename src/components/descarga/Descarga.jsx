...
import phoneImage from '../../assets/des.webp';
      ...
      <div className="descarga-content">
        <div className="descarga-text-column">
          ...
          <div className="descarga-buttons">
            <a href="https://apps.apple.com/ec/app/uber-autos-motos-taxi-y-m%C3%A1s/id368677368" target="_blank" rel="noopener noreferrer" aria-label="Descargar en la App Store">
              <img src={appStoreImage} alt="Botón de App Store" />
            </a>
            <a href="https://play.google.com/store/apps/details?id=com.ubercab&hl=es_EC" target="_blank" rel="noopener noreferrer" aria-label="Descargar en Google Play">
